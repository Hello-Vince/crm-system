...
sys.path.insert(0, str(BASE_DIR.parent.parent / 'libs' / 'shared-python'))
...
MIDDLEWARE = [
    ...
    'shared_python.jwt_auth.JWTAuthenticationMiddleware',  # JWT auth
]
...
GRAPHENE = {
    'SCHEMA': 'crm_project.schema.schema'
}
